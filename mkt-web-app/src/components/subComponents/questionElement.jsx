...
class QuestionSubComponent extends Component {
    ...
    updateQuestion() {
        NetworkUtils.commonPost('/updateQuestion', this.state.questionObject);
        this.setState({
            isEditting: false
        });
    }
    ...
    deleteQuestion() {
        NetworkUtils.commonPost('/deleteQuestion', {'_id' : this.state.questionObject._id['$oid']});
        this.setState({
            isNotDeleted: false
        })
    }
